...
export const HeroSlide = ({ description, image, isNew, slug, title }: HeroSlideProps) => {
  ...
  return (
    <div className='relative grid h-full grid-cols-1 grid-rows-[1fr_380px] gap-7 lg:w-full lg:grid-cols-2 lg:grid-rows-[minmax(450px,1fr)]'>
      <div className='lg:p-18 flex flex-col justify-center gap-[10px] px-6 py-3 tablet:gap-3 tablet:py-10 tablet:text-center lg:text-start'>
        ...
        <p className='text-light-500 text-justify text-sm tablet:text-center tablet:text-base lg:w-[85%] lg:text-justify'>
          {description}
        </p>
