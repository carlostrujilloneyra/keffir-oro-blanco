...
export const HeroCarousel = () => {
  ...
  return (
    <section className='lg:container-max h-[600px] w-[calc(100%)] rounded-lg bg-gradient-to-r from-black via-[#2a2a2a] to-[#2e2e2e] px-6 py-8 md:h-[660px] md:px-10 md:py-6 lg:w-full lg:px-20 lg:py-20'>
      <Swiper
        loop
        autoplay={{ delay: 5000 }}
        speed={800}
